...
int main() {
	while (true) {
		...
		std::cout << "y - Solving system of linear equations using Jacobie Method" << std::endl;
		std::cout << "u - " << std::endl;
